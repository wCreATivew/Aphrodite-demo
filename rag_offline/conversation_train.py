...
def main() -> int:
    ...
    ap.add_argument("--triplets-out", default="var/data/rag/conversation_triplets.jsonl")
    ap.add_argument("--sessions-out", default="var/data/rag/conversation_sessions.jsonl")
    ap.add_argument("--corpus-out", default="var/data/rag/conversation_corpus.json")
    ...
    ap.add_argument("--out-model", default="var/models/embedding/rag_embed_model_conversation")
